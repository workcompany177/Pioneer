      ...
      <Container style={{ direction: 'rtl', textAlign: 'right', color: '#fff' }} className="my-4">
        ...
        <Row className="gy-4 justify-content-center">
          <Col xs={12} sm={6} md={5} lg={4}>
            <Card
              ...
              onClick={() => navigate('/second-year/videos')}
            >
              <Card.Img
                variant="top"
          ...
          <Col xs={12} sm={6} md={5} lg={4}>
            <Card
              style={{ background: 'transparent', border: 'none', cursor: 'pointer' }}
              onClick={() => navigate('/second-year/files')}
            >
              <Card.Img
                variant="top"
        ...
        <Row className="gy-4 justify-content-center" style={{ marginTop: '20px' }}>
          <Col xs={12} sm={6} md={5} lg={4}>
            <Card
              style={{ background: 'transparent', border: 'none', cursor: 'pointer' }}
              onClick={() => navigate('/second-year/homework')}
            >
              <Card.Img
                variant="top"
          ...
          <Col xs={12} sm={6} md={5} lg={4}>
            <Card
              style={{ background: 'transparent', border: 'none', cursor: 'pointer' }}
              onClick={() => navigate('/second-year/exams')}
            >
              <Card.Img
                variant="top"

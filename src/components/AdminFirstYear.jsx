...
function AdminFirstYear() {
  ...
  useEffect(() => {
    const fetchVideos = async () => {
      try {
        const res = await fetch(
          'https://raw.githubusercontent.com/workcompany177/trash/main/grade1/videos.json'
        );
    ...
    const fetchFiles = async () => {
      try {
        const res = await fetch(
          'https://raw.githubusercontent.com/workcompany177/trash/main/grade1/files.json'
        );
    ...
    const fetchHomework = async () => {
      try {
        const res = await fetch(
          'https://raw.githubusercontent.com/workcompany177/trash/main/grade1/homework.json'
        );
    ...
    const fetchExams = async () => {
      try {
        const res = await fetch(
          'https://raw.githubusercontent.com/workcompany177/trash/main/grade1/exams.json'
        );
  ...
  return (
    <Container style={{ direction: 'rtl', textAlign: 'right', color: '#fff' }} className="my-4">
      <h2 className="mb-4" style={{ textAlign: 'center', marginTop: '60px' }}>
        الصف الأول الثانوي - لوحة الأدمن
      </h2>

      {/* بوكسات (فيديوهات / ملفات / واجبات / امتحانات) */}
